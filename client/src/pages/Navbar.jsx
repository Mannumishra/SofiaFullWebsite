                    ...
                    <div style={{ alignItems: 'center' }} className="row pb-2 top-row">
                        <div className="col-12 col-md-4 text-center text-md-start mb-2 mb-md-0">
                            <div className="logoIcon">
                                ...
                                <Link target='_blank' to="https://wa.me/919015555501"><FaWhatsapp size={20} className='icon m-1' /></Link>
                                <Link target='_blank' to="https://www.linkedin.com/in/sofia-surgicals-pvt-ltd-231310126?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app"><FaLinkedin size={20} className='icon m-1' /></Link>
                                <Link target='_blank' to="https://www.instagram.com/sofia_surgicals/profilecard/?igsh=ZHF1am5xeHFjYmY2"><FaInstagram size={20} className='icon m-1' /></Link>
                                <Link target='_blank' to="https://x.com/sofiasurgicals?s=11"><BsTwitterX size={20} className='icon m-1' /></Link>
                                <Link target='_blank' to="https://youtube.com/@sofiasurgicals4790?si=QhwQt4xWsRBh6VF4"><FaYoutube size={20} className='icon m-1' /></Link>
                            </div>
                        </div>
