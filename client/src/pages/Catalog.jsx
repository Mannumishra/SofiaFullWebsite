...
function Catalog() {
    ...
    const getApiData = async () => {
        try {
            const res = await axios.get("http://localhost:8000/api/all-catalog");
    ...
    const postData = async (e) => {
        ...
        try {
            ...
            const response = await axios.post("http://localhost:8000/api/download-catelog", updatedFormData);
                            ...
                            <div key={index} className="col-md-3 mb-4">
                                <div className="category-card">
                                    <img
                                        ...
                                        className="img-fluid"
                                        src={`http://localhost:8000/${item.catalogImage}`}
                                        width="250"
                                        height="230"
                                    />
