...
const EditCatalog = () => {
    ...
    useEffect(() => {
        const fetchCatalog = async () => {
            try {
                const response = await axios.get(`https://api.sofia.digiindiasolutions.com/api/single-catalog/${id}`);
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`https://api.sofia.digiindiasolutions.com/api/update-catalog/${id}`, updateData, {
                headers: {
