...
const EditInplants = () => {
    ...
    useEffect(() => {
        const fetchInplant = async () => {
            try {
                const response = await axios.get(`https://api.sofia.digiindiasolutions.com/api/inplants/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        setIsLoading(true);
        try {
            const response = await axios.put(`https://api.sofia.digiindiasolutions.com/api/update-inplants/${id}`, data, {
                headers: {
