...
const EditCategory = () => {
    ...
    useEffect(() => {
        const fetchCategory = async () => {
            try {
                const response = await axios.get(`https://api.sofia.digiindiasolutions.com/api/get-category/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        setBtnLoading(true);
        try {
            const response = await axios.put(`https://api.sofia.digiindiasolutions.com/api/update-category/${id}`, data, {
                headers: {
