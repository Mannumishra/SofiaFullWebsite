...
const EditTestimonial = () => {
    ...
    useEffect(() => {
        ...
        const fetchTestimonial = async () => {
            try {
                const response = await axios.get(`http://localhost:8000/api/get-single-textimonial/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`http://localhost:8000/api/update-textimonial/${id}`, data, {
                headers: {
                ...
                <form className="row g-3" onSubmit={handleSubmit}>
                    ...
                    <div className="col-md-4">
                        ...
                        {image && typeof image === 'string' && (
                            <img src={`http://localhost:8000/${image}`} alt="Current" width="50" height="50" className="mt-2" />
                        )}
                    </div>
