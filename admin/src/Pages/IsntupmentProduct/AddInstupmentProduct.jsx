...
const AddInstupmentProduct = () => {
    ...
    useEffect(() => {
        const fetchinstupment = async () => {
            ...
            setIsLoading(true);
            try {
                const response = await axios.get('https://api.sofia.digiindiasolutions.com/api/all-instupment-after-details');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://api.sofia.digiindiasolutions.com/api/create-instupment-product', data, {
                headers: {
