...
const EditProduct = () => {
    ...
    useEffect(() => {
        ...
        const fetchProductDetails = async () => {
            setIsLoading(true);
            try {
                const response = await axios.get(`https://api.sofiasurgicals.com/api/single-inplants-product/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`https://api.sofiasurgicals.com/api/update-inplants-product/${id}`, data, {
                headers: {
